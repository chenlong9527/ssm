...
<body>
<form  action="${pageContext.request.contextPath}/queryemp.do" method="post">
...
<button><a href="${pageContext.request.contextPath}/Jsp/empAdd.jsp">添加</a></button>
...
<c:forEach varStatus="sta" var="emp" items="${list}">
    <tr>
